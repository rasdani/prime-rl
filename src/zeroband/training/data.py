...
def get_dataloader(tokenizer, batch_size: int, data_config: DataConfig, pad_token_id: int) -> DataLoader[BatchOutput]:
    ...
    collate_fn = PaddingColate(data_config.seq_length, pad_token_id)
